!(function($) {
    ...
    // PT-BR: Ação de carregar o conteúdo da página
    function pageData() {
        let url = window.location.origin + '/.callback/website/loadAbout.php';
        $.post(url, {}, function(callback){
          document.getElementById('description').innerHTML = callback[0].description;         
        });
    }    
    pageData(); 
  })(jQuery);